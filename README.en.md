...
# XXD Panel 225｜办公物件手绘拼贴

Retell an ordinary photograph as a visual diary of notes, clips, tape and paper.
...
<table>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-05.png" alt="XXD Panel 225 Sample 5"></td>
    <td width="50%"><img src="./assets/examples/sample-06.png" alt="XXD Panel 225 Sample 6"></td>
  </tr>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-07.png" alt="XXD Panel 225 Sample 7"></td>
    <td width="50%"><img src="./assets/examples/sample-08.png" alt="XXD Panel 225 Sample 8"></td>
  </tr>
</table>
...
<table>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-09.png" alt="XXD Panel 225 additional top-bottom sample 1"></td>
    <td width="50%"><img src="./assets/examples/sample-10.png" alt="XXD Panel 225 additional top-bottom sample 2"></td>
  </tr>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-11.png" alt="XXD Panel 225 additional top-bottom sample 3"></td>
    <td width="50%"><img src="./assets/examples/sample-12.png" alt="XXD Panel 225 additional top-bottom sample 4"></td>
  </tr>
</table>

## Best-fit situations and problems solved

For turning an everyday photograph into an editorial illustration or visual diary: personal archives, independent publishing, exhibition studies and lifestyle brands. The upper half keeps a recognisable source photograph; the lower half is not a sticker dump or planner template. It first reads meaning and mood, then retells them through office objects, paper collage and sparse handwriting.

The result should feel selective, object-led, hand-collaged and spacious: restrained, sharp, poetic and contemporary. Avoid literal copies, filled frames, material dumps, commercial planner templates, cartoon styling and cheap collage.
...
```bash
npx skills add https://github.com/nevertoday/xxd-panel-225 --skill xxd-panel-225
```

Restart the agent session after installation, then invoke `$xxd-panel-225`. Add `--global --agent codex --yes` when a user-level Codex installation is wanted.

Common examples:

```text
/xxd-panel-225 photo.jpg --mode top-bottom --size 3:4 --text prompt --locale en-US
/xxd-panel-225 photo.jpg --mode left-right --size 16:9 --text prompt --locale en-US
/xxd-panel-225 photo.jpg --mode design-only --size 9:16 --text none --prefs off
/xxd-panel-225 ./photos --mode design-only --size auto,3:4 --text prompt --locale ja-JP
```

See [SKILL.md](SKILL.md) for the full runtime contract and the [English](references/xxd-panel-225-prompt.en.md) or [Chinese](references/xxd-panel-225-prompt.zh-CN.md) runtime adapter.
...
- `design-only`: the full canvas contains only Panel 225's designed translation; the photograph remains a non-visible reference.
