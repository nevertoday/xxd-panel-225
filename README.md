...
<table>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-05.png" alt="XXD Panel 225 样张 5"></td>
    <td width="50%"><img src="./assets/examples/sample-06.png" alt="XXD Panel 225 样张 6"></td>
  </tr>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-07.png" alt="XXD Panel 225 样张 7"></td>
    <td width="50%"><img src="./assets/examples/sample-08.png" alt="XXD Panel 225 样张 8"></td>
  </tr>
</table>
...
<table>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-09.png" alt="XXD Panel 225 新增上下样张 1"></td>
    <td width="50%"><img src="./assets/examples/sample-10.png" alt="XXD Panel 225 新增上下样张 2"></td>
  </tr>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-11.png" alt="XXD Panel 225 新增上下样张 3"></td>
    <td width="50%"><img src="./assets/examples/sample-12.png" alt="XXD Panel 225 新增上下样张 4"></td>
  </tr>
</table>

## 适用场景与解决的问题

适合想把日常照片做成编辑插画或视觉日记的场合：个人摄影整理、独立出版、展览练习、生活方式品牌。上半保留可辨认的原照；下半不是贴纸堆或手帐模板，而是先读懂含义与情绪，再用办公室物件做转喻，手绘拼贴出值得停留的片刻。

整体呈现选择性记忆、物件叙事、手绘拼贴与大面积留白的气质：克制、敏锐、诗意、当代。避免逐物复刻、画面铺满、素材罗列、商业手帐模板感、卡通感和廉价拼贴感。
...
安装后重新启动 Agent 会话，然后调用 `$xxd-panel-225`。也可以按需追加 `--global --agent codex --yes` 做用户级安装。

常用调用示例：

```text
/xxd-panel-225 photo.jpg --mode top-bottom --size 3:4 --text prompt --locale zh-CN
...
完整运行契约见 [SKILL.md](SKILL.md)；运行适配器见 [英文](references/xxd-panel-225-prompt.en.md) 与 [中文](references/xxd-panel-225-prompt.zh-CN.md)。
...
- `design-only`：整张画布只呈现 Panel 225 的设计转译，照片只作为不可见参考。
