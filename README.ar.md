...
أعد كتابة صورة يومية كيوميات بصرية من الملاحظات والمشابك والشريط والورق.
...
لتحويل صورة يومية إلى رسم تحريري أو يوميات بصرية: أرشيف شخصي، نشر مستقل، دراسات معرض وعلامات أسلوب حياة. النصف العلوي يحتفظ بالصورة الأصلية؛ والنصف السفلي ليس كومة ملصقات أو قالب مفكرة. يقرأ المعنى والمزاج ثم يعيد سرده بأشياء المكتب والكولاژ اليدوي وكتابة قليلة.

النتيجة انتقائية، قائمة على الأشياء، مقصوصة باليد وواسعة الفراغ: مقيدة وحادة وشعرية ومعاصرة. تجنّب النسخ الحرفي، وملء الإطار، ورصّ المواد، وقوالب المفكرة التجارية، والكارتون، والكولاژ الرخيص.
...
بعد التثبيت أعد تشغيل جلسة Agent ثم استدعِ `$xxd-panel-225`. ويمكن إضافة `--global --agent codex --yes` للتثبيت على مستوى المستخدم.

```text
/xxd-panel-225 photo.jpg --mode top-bottom --size 3:4 --text prompt --locale ar-SA
...
راجع [SKILL.md](SKILL.md) لعقد التشغيل الكامل، ومهايئ التشغيل [بالإنجليزية](references/xxd-panel-225-prompt.en.md) أو [بالصينية](references/xxd-panel-225-prompt.zh-CN.md).
...
- `design-only`: تعرض اللوحة الكاملة ترجمة Panel 225 التصميمية فقط، وتبقى الصورة مرجعاً غير ظاهر.
